...
config :women_in_tech_vic, WomenInTechVic.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "women_in_tech_vic_dev",
  stacktrace: true,
...
config :women_in_tech_vic, WomenInTechVicWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "zvxlm3pwTLKlsY8p+GHnkhtY8RiPBVnbhCq3lOyrGjkLsldQjwegZ5brWQUntp4r",
  watchers: [
...
config :women_in_tech_vic, WomenInTechVicWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/women_in_tech_vic_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
