defmodule WomenInTechVicWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      WomenInTechVicWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule WomenInTechVicWeb.PageLive do
        use WomenInTechVicWeb, :live_view

        on_mount {WomenInTechVicWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{WomenInTechVicWeb.UserAuth, :ensure_authenticated}] do
  ...
  def on_mount(:redirect_if_profile_exists, _params, session, socket) do
    ...
    case Accounts.find_profile(%{user_id: user_id}) do
      {:ok, %Profile{}} ->
        socket =
          Phoenix.LiveView.redirect(socket, to: ~p"/profiles/show/#{username}")
