defmodule WomenInTechVicWeb.CustomComponents do
  ...
  def event_display(assigns) do
    ~H"""
    <div class="w-full max-w-lg break-words group relative p-6 rounded-lg shadow-md mb-8 border border-gray-300 bg-gradient-to-r from-pink-200 via-gray-100 to-pink-300">
