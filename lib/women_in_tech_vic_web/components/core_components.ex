defmodule WomenInTechVicWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    ~H"""
    <div>
      <label class="flex items-center gap-4 text leading-6 text-zinc-600">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WomenInTechVicWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WomenInTechVicWeb.Gettext, "errors", msg, opts)
    end
  end
